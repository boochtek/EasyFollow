class Connection < ActiveRecord::Base
  ...
  attribute :networks,  :string, :required => true, :default => '' # comma-separated list of all networks shared between the 2 users
  ...
  validates_format_of :networks, :with => /\A[a-zA-Z_,]*\Z/, :message => 'must be a comma-separated list of SocialNetworkSite names.'
