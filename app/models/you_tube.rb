...
class YouTube < OAuthSite
  class << self
    ...
    def get_user_details(account)
      ...
      username   = xml.xpath('//entry/yt:userame/text()',   {'yt' => 'http://gdata.youtube.com/schemas/2007'}).to_s
      first_name = xml.xpath('//entry/yt:firstName/text()', {'yt' => 'http://gdata.youtube.com/schemas/2007'}).to_s
      last_name  = xml.xpath('//entry/yt:lastName/text()',  {'yt' => 'http://gdata.youtube.com/schemas/2007'}).to_s
